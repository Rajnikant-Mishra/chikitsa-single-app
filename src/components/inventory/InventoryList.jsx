...
export default function App() {
  ...
  className="flex-1 overflow-y-auto p-10 sm:p-6 space-y-4"
>
              {activeTab === "device" && (
                <>
                  <div>
           ...
           <div className="sticky bottom-0 bg-white pt-4 border-t border-slate-100 flex flex-col sm:flex-row justify-end gap-3 px-4 sm:px-6 pb-4">
        <button
  type="button"
  onClick={handleCloseModal}
  className="w-full sm:w-auto px-5 py-2.5 rounded-xl border border-slate-200 text-slate-600 font-semibold"
>
  Cancel
</button>
...
<button
  type="submit"
  className="w-full sm:w-auto px-5 py-2 rounded-xl bg-[#0e4a67] text-white hover:bg-[#155e82] font-bold shadow-sm"
>
  Commit Entry
</button>
              </div>
