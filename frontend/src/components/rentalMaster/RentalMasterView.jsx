  ...
  if (error || !rental) {
    return (
      <DashboardLayout>
        <div className="w-full mx-auto max-w-xl bg-rose-50 rounded-2xl p-6 border border-rose-100 shadow-sm text-center mt-12 space-y-4">
          <div className="text-rose-600 text-3xl font-black">✕</div>
          <h3 className="text-lg font-black text-rose-900">Unable to load</h3>
      ...
      <div className="w-full mx-auto space-y-6 p-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <span className="font-bold text-slate-900 text-base">
                  {rental.accessory?.accessory_name ||
                    rental.accessory_id ||
                    "N/A"}
                </span>
              </div>
              ...
              <div>
                ...
                <span
                  className={`inline-block px-3 py-1 text-xs font-black rounded-xl mt-0.5 ${
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <span className="font-bold text-emerald-700 text-base uppercase tracking-wide">
                  {rental.billing_type || "—"}
                </span>
              </div>
              <div>
                ...
                <span className="font-bold text-slate-900 text-base">
                  ₹{Number(rental.rental_charge || 0).toLocaleString()}
                </span>
              </div>
              <div>
                <span className="block text-slate-400 font-medium mb-0.5">
                ...
                <span className="font-bold text-slate-900 text-base">
                  ₹{Number(rental.deposit_advance || 0).toLocaleString()}
                </span>
              </div>
              <div>
                <span className="block text-slate-400 font-medium mb-0.5">
                ...
                <span className="font-bold text-slate-900 text-base">
                  ₹{Number(rental.installation_charge || 0).toLocaleString()}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="grid grid-cols-2 border-b border-slate-50 pb-2">
                ...
                <span className="font-bold text-slate-900">
                  {rental.patient_age ? `${rental.patient_age} Yrs` : "—"}
                </span>
              </div>
              <div className="grid grid-cols-2 border-b border-slate-50 pb-2">
                <span className="text-slate-400 font-medium">Mobile:</span>
                <span className="font-bold text-slate-900">
                  {rental.patient_mob_no || "—"}
                </span>
              </div>
              <div className="grid grid-cols-2 border-b border-slate-50 pb-2">
                <span className="text-slate-400 font-medium">Alt Mobile:</span>
                <span className="font-bold text-slate-900">
                  {rental.patient_alternative_mob_no || "—"}
                </span>
              </div>
              <div className="grid grid-cols-2 border-b border-slate-50 pb-2">
                <span className="text-slate-400 font-medium">Attendant:</span>
                <span className="font-bold text-slate-900">
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-4">
            ...
            <div className="space-y-3 text-sm">
              <div className="grid grid-cols-2 border-b border-slate-50 pb-2">
                <span className="text-slate-400 font-medium">Care Center:</span>
                <span className="font-bold text-slate-900">
              ...
              <div className="grid grid-cols-2 border-b border-slate-50 pb-2">
                <span className="text-slate-400 font-medium">POC Mobile:</span>
                <span className="font-bold text-slate-900">
                  {rental.mob_no || "—"}
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 border-b border-slate-50 pb-2">
                <span className="text-slate-400 font-medium">Referral:</span>
                <span className="font-bold text-slate-900">
                  {rental.care_referal || "—"}
                </span>
              </div>
        ...
        {rental.notes && (
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
            <h4 className="text-sm font-extrabold text-slate-400 uppercase tracking-wider border-b border-slate-100 pb-2 mb-3">
              📝 Notes
            </h4>
