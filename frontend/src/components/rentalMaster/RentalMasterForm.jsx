...
//     status: "Pending",
//     device_id: "", // Track correct integer key expected by Sequelize
//   });
...
//   const [deviceModels, setDeviceModels] = useState([]); // Master tracking list holding full device objects
//   const [inventoryList, setInventoryList] = useState([]);
//   const [filteredSerials, setFilteredSerials] = useState([]);
//   const [assetPhotos, setAssetPhotos] = useState([]);
//   const [isSubmitting, setIsSubmitting] = useState(false);

//   // Fetch unique device profiles and map structural keys
//   useEffect(() => {
...
//         // Filter active options but preserve the complete row structure (id + name)
...
//   // Fetch inventories to match serial numbers downstream
//   useEffect(() => {
...
//   // Filter serial numbers dynamically whenever the selected device structural target swings
//   useEffect(() => {
//     if (formData?.device_id) {
//       // Find name string corresponding to chosen integer state ID
...
//         if (key === "device" || key === "asset_photos") return;
...
//                     setFormData({
//                       ...formData,
//                       care_center_name: e.target.value,
//                     })
//                   }
...
// import React, { useState, useEffect } from "react";
// import { useNavigate } from "react-router-dom"; // Added for routing context redirection
// import DashboardLayout from "../Admin/Layout";
...
//   // Filter serial numbers dynamically whenever the selected device structural target changes
//   useEffect(() => {
//     if (formData?.device_id) {
//       const chosenDeviceObj = deviceModels.find(
//         (d) => Number(d.device_id) === Number(formData.device_id)
...
//   const handleRemovePhoto = (idToRemove) => {
//     setAssetPhotos((prevPhotos) => prevPhotos.filter((p) => p.id !== idToRemove));
//   };
...
//       // Clear redirect execution tracking sequence path layout updates cleanly
...
//                     setFormData({
//                       ...formData,
//                       rental_charge: e.target.value === "" ? 0 : Number(e.target.value),
//                     })
//                   }
//                   className="w-full px-4 py-3 border border-slate-300 rounded-xl text-base text-slate-900 focus:outline-none shadow-sm"
//                 />
...
//                     setFormData({
//                       ...formData,
//                       deposit_advance: e.target.value === "" ? 0 : Number(e.target.value),
//                     })
//                   }
//                   className="w-full px-4 py-3 border border-slate-300 rounded-xl text-base text-slate-900 focus:outline-none shadow-sm"
//                 />
...
//                     setFormData({
//                       ...formData,
//                       installation_charge: e.target.value === "" ? 0 : Number(e.target.value),
//                     })
//                   }
//                   className="w-full px-4 py-3 border border-slate-300 rounded-xl text-base text-slate-900 focus:outline-none shadow-sm"
//                 />
...
//             {/* CARE CENTER */}
//             <div className="space-y-4">
//               <p className="text-xs font-bold text-[#0e4a67] uppercase tracking-wide border-b pb-2">🏢 Care Center Context</p>
//               <div>
...
//               <div className="grid grid-cols-2 gap-4">
//                 <div>
//                   <label className="block text-sm font-bold text-slate-700 mb-1.5">POC Mobile</label>
//                   <input
//                     type="text"
//                     value={formData?.mob_no || ""}
...
//                 </div>
//                 <div>
//                   <label className="block text-sm font-bold text-slate-700 mb-1.5">Alt POC Mobile</label>
//                   <input
//                     type="text"
//                     value={formData?.alternative_mob_no || ""}
//                     onChange={(e) => setFormData({ ...formData, alternative_mob_no: e.target.value })}
//                     className="w-full px-4 py-3 border border-slate-300 rounded-xl text-slate-900 focus:outline-none shadow-sm"
//                   />
//                 </div>
//               </div>
//               <div>
//                 <label className="block text-sm font-bold text-slate-700 mb-1.5">Care Address</label>
//                 <textarea
//                   rows="2"
//                   value={formData?.care_address || ""}
...
//               <div className="grid grid-cols-2 gap-4">
//                 <div>
//                   <label className="block text-sm font-bold text-slate-700 mb-1.5">Bed No</label>
//                   <input
//                     type="text"
//                     value={formData?.care_bed_no || ""}
...
//               </div>
//               <div>
//                 <label className="block text-sm font-bold text-slate-700 mb-1.5">Referral</label>
//                 <input
//                   type="text"
//                   value={formData?.care_referal || ""}
//                   onChange={(e) => setFormData({ ...formData, care_referal: e.target.value })}
//                   className="w-full px-4 py-3 border border-slate-300 rounded-xl text-slate-900 focus:outline-none shadow-sm"
//                 />
//               </div>
//             </div>
...
//             {/* PATIENT DETAILS */}
//             <div className="space-y-4">
//               <p className="text-xs font-bold text-[#0e4a67] uppercase tracking-wide border-b pb-2">👤 Patient Identity Details</p>
//               <div className="grid grid-cols-3 gap-3">
//                 <div className="col-span-2">
...
//                       setFormData({
//                         ...formData,
//                         patient_age: e.target.value === "" ? "" : Number(e.target.value),
//                       })
//                     }
//                     className="w-full px-4 py-3 border border-slate-300 rounded-xl text-slate-900 focus:outline-none shadow-sm"
//                   />
...
//                 </div>
//                 <div>
//                   <label className="block text-sm font-bold text-slate-700 mb-1.5">Alt Mobile Number</label>
//                   <input
//                     type="text"
//                     value={formData?.patient_alternative_mob_no || ""}
//                     onChange={(e) => setFormData({ ...formData, patient_alternative_mob_no: e.target.value })}
//                     className="w-full px-4 py-3 border border-slate-300 rounded-xl text-slate-900 focus:outline-none shadow-sm"
//                   />
//                 </div>
//               </div>
...
export default function RentalForm({
  ...
  // ===============================
  // CARE CENTER SELECT HANDLER
  // ===============================
  const handleCareCenterChange = (e) => {
    const selectedId = e.target.value;
    
    if (!selectedId) {
      // Clear logistics details if deselected
      setFormData({
        ...formData,
        care_center_id: "",
        mob_no: "",
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      Object.keys(formData).forEach((key) => {
        if (key === "device" || key === "careCenter" || key === "asset_photos") return;
      ...
      <div className="w-full mx-auto space-y-6 p-2">
        ...
        <form onSubmit={handleFormSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* CARE CENTER - Updated drop-down section */}
            <div className="space-y-4">
              <p className="text-xs font-bold text-[#0e4a67] uppercase tracking-wide border-b pb-2">🏢 Care Center Context</p>
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-1.5">Care Center Name</label>
                ...
                >
                  ...
                  {careCenters.map((center) => (
                    <option key={center.carecenter_id} value={center.carecenter_id}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    disabled // Auto-filled from center select
                    value={formData?.mob_no || ""}
                    className="w-full px-4 py-3 border border-slate-200 bg-slate-50 text-slate-500 rounded-xl focus:outline-none shadow-sm"
                  />
                </div>
                <div>
                  <label className="block text-sm font-bold text-slate-700 mb-1.5">Alt POC Mobile</label>
              ...
              <div>
                ...
                <textarea
                  ...
                  disabled // Auto-filled from center select
                  value={formData?.care_address || ""}
                  className="w-full px-4 py-3 border border-slate-200 bg-slate-50 text-slate-500 rounded-xl focus:outline-none shadow-sm resize-none"
                />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
